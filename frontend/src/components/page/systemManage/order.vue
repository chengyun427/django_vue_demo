<template>
  ...
  <div>
    <div>
      ...
      >
        ...
        <el-form-item label="状态" prop="orderState">
          <el-input v-model="formInline.orderState" clearable></el-input>
        </el-form-item>
        <el-form-item label="日期" prop="orderDateStart">
          <!-- <el-select v-model="formInline.orderDateStart" class="inputWidth" clearable placeholder="请选择">
            <el-option style="padding-right:0px !important" v-for="item in optionStart" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>-->
          <el-date-picker
            class="inputWidth"
        ...
        <el-form-item label="-" prop="orderDateEnd">
          <!-- <el-select v-model="formInline.orderDateEnd" class="inputWidth" clearable placeholder="请选择">
            <el-option style="padding-right:0px !important" v-for="item in optionEnd" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>-->
          <el-date-picker
            class="inputWidth"
    ...
    <div class="handle-box">
      <el-button type="primary" icon="el-icon-search" @click="searchDetail('addInfo')">查看详情</el-button>
    ...
    >
      ...
      >
        ...
        <el-form-item label="订单编号" prop="orderNumber">
          <el-input v-model="addInfo.orderNumber" clearable class="inputWidth"></el-input>
        </el-form-item>
        ...
        <el-form-item label="订单日期" prop="orderDate">
          <el-input v-model="addInfo.orderDate" clearable class="inputWidth"></el-input>
        </el-form-item>
        <el-form-item label="收货地址" prop="orderAddress">
          <el-input v-model="addInfo.orderAddress" clearable class="inputWidth"></el-input>
        </el-form-item>
        ...
        <el-form-item label="发货留言" prop="orderRemark">
          <el-input type="textarea" v-model="addInfo.orderRemark" clearable style="width:400px"></el-input>
        </el-form-item>
      </el-form>
      <div class="small-top">订单详情</div>
      <el-table
      ...
      >
        <!--  ref="multipleTable" -->
        <el-table-column type="selection" width="55"></el-table-column>
        <el-table-column prop="pictureAddress" label="商品首图" width="150"></el-table-column>
  ...
  data() {
    ...
    return {
      ...
      tableData: [
        // {
        //   orderId: "1",
        //   orderNumber: "20194282104123456",
        //   orderPrice: "996",
        //   customerId:"1",
        //   customerName: "Chancey",
        //   orderState: "已处理",
        //   orderDate: "2019-4-28",
        //   receiveTel:"12345678901",
        //   orderAddress:"广东东软学院",
        //   receiveContact:"张三",
        //   orderRemark:"快点"
        // },
        // {
        //   orderNumber: "20194282104456789",
        //   orderPrice: "996",
        //   customerName: "Chancey",
        //   orderState: "未处理",
        //   orderDate: "2019-4-28"
      ...
      getDetailUrl: this.$store.state.url + "orderManagement/backend/order/getOrderDetail",//查看详情
      getUserByUserCodeUrl:
        this.$store.state.url + "webauth/user/getUserByUserCode", //修改获取用户信息
